    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black snap-start snap-always">
      ...
      <div className="relative z-10 text-center px-4">
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-bold mb-4 md:mb-6 text-white leading-tight"
        >
          Viltinventering
          <br />
        ...
        <motion.p
          ...
          className="text-sm sm:text-base md:text-lg lg:text-xl text-white/80 max-w-2xl mx-auto mt-4 md:mt-6 leading-relaxed"
        >
